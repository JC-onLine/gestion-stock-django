...
class CategoryCreateView(CreateView):
    model = Category
    template_name = 'open_stock/category_create.html'
...
class CategoryListView(ListView):
    model = Category
    template_name = 'open_stock/category_list.html'
...
class CategoryDetailView(DetailView):
    model = Category
    template_name = 'open_stock/category_detail.html'
...
class CategoryUpdateView(UpdateView):
    model = Category
    template_name = 'open_stock/category_update.html'
    fields = ['name', 'description']
...
class CategoryDeleteView(DeleteView):
    model = Category
    template_name = 'open_stock/category_delete.html'
